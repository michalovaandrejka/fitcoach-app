...
const AVATARS = [
  { id: 1, icon: "person-outline" as const, color: "#FF6B35" },
  { id: 2, icon: "pulse-outline" as const, color: "#4CAF50" },
  { id: 3, icon: "heart-outline" as const, color: "#E91E63" },
  { id: 4, icon: "flash-outline" as const, color: "#9C27B0" },
];
