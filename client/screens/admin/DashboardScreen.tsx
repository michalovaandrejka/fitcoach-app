    ...
    <ThemedView style={styles.container}>
      ...
      >
        ...
        <View style={styles.statsGrid}>
          <StatCard icon="people-outline" label="Klientů celkem" value={stats.clientsCount} color={theme.primary} />
          <StatCard icon="calendar-outline" label="Tréninků dnes" value={stats.todayBookings} color={theme.secondary} />
        </View>
